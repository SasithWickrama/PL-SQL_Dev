CREATE OR REPLACE PROCEDURE CLARITY_ADMIN.PEND_PEOTV_WO_DETAILS_DATA AS
...
CURSOR GET_BASE_DATA IS
             ((SELECT 
                ...
                (SELECT MAX(SOFE_DEFAULTVALUE) 
                FROM SERVICE_ORDER_FEATURES 
                WHERE SOFE_SERO_ID = WORO_SERO_ID 
                AND SOFE_FEATURE_NAME= 'INTERNET')      "ADSL",
                (SELECT MAX(SOFE_DEFAULTVALUE) 
                FROM SERVICE_ORDER_FEATURES 
                WHERE SOFE_SERO_ID = WORO_SERO_ID 
                AND SOFE_FEATURE_NAME= 'IPTV')          "IPTV",
                ...
                AND SEIT_TASKNAME IN ('STB INSTALLATION','INSTALL SET TOP BOX','COLLECT CPE', 'WO FOR SITE VISIT')
...
INSERT INTO CLARITY_ADMIN.PENDING_PEOTV_WO_DETAILS
(
CCT_ID,
REGION,
PROVINCE,
...
GET_BASE_DATA_REC.ADSL,
GET_BASE_DATA_REC.IPTV,
