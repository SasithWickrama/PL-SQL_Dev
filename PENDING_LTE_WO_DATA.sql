CREATE OR REPLACE PROCEDURE CLARITY_ADMIN.PENDING_LTE_WO_DATA AS
...
CURSOR GET_BASE_DATA IS
                    ...
                    AND SERO_SERT_ABBREVIATION IN ('AB-WIRELESS ACCESS','BB-INTERNET','V-VOICE','E-IPTV')
...
INSERT INTO CLARITY_ADMIN.PENDING_LTE_WO
(
CIRCUIT,
REGION,
PROVINCE,
