CREATE OR REPLACE PROCEDURE CLARITY_ADMIN.PEND_RG_MDF_WO_DETAILS_MAIL IS

    CURSOR C_DETAIL IS     
     SELECT count(*)
     FROM CLARITY_ADMIN.RPT_WG_RELATED_X_CONN_INFO;
  ...
  l_name VARCHAR2(80) := 'RG_OSP_Pending_WO_Details.xls';
  l_blob CLOB;
...
dbms_output.put_line('@6') ;
 ...
 dbms_output.put_line('@7') ;
  ...
  v_sms_txt := 'Dear%20All%20RG%20OSP%20pending%20WO%20detail%20report%20as%20@%20today%20contain%20' ||v_ren_CNT|| '%20records.%20Please%20check%20your%20mails. ';
        v_mobile:='716834441'; 
...
BEGIN
      ...
      SELECT HOST_NAME INTO GET_IP_OF_DATABASE FROM V$INSTANCE;
        ...
        IF IP_FLAG = 'Y' THEN
            ...
            CLARITY_ADMIN.UPD_RPT_WG_INFO_TABLE;
    ...
    FOR D_RG_MDF_COUNT IN C_RG_WO_COUNT 
      ...
      l_body := '<html><head><title>RG OSP Pending WO Details'
         ...
         || v_cl
         || '<br><br>'
         || 'Please find the Ragama OSP Pending WO Detail Report AS @ '
         || v_ren_date
         || '.'
         || '<br>'
         || 'Report contain '
      ...
      send_mail(p_to          => 'nihal@slt.com.lk',
                p_to_A        => 'lidira@slt.com.lk',
                p_to_B        => 'gayanis@slt.com.lk',
                p_to_C        => 'aamara@slt.com.lk',
                p_to_D        => 'yasindul@slt.com.lk',
                p_to_E        => 'sagas@slt.com.lk',
                p_to_F        => 'amilal@slt.com.lk',
                p_from        => 'cdinesh@slt.com.lk',
                p_subject     => 'RG OSP Pending WO Details',
                p_text_msg    => l_body,
                p_attach_name => 'RG_OSP_Pending_WO_Details.xls',
                p_attach_mime => 'xls',
    ...
    DELETE FROM CLARITY_ADMIN.RPT_WG_RELATED_X_CONN_INFO;
