CREATE OR REPLACE PROCEDURE CLARITY_ADMIN.PENDING_WIFI_PE_TASKS_DATA AS
...
CURSOR GET_BASE_DATA IS
                    SELECT
                       ...
                       (SELECT DISTINCT SLTA_RTOM 
                        ...
                        SEOA_DEFAULTVALUE       "LOCATION_NAME",
                        ...
                        AND PLAE_ACTT_ABBREVIATION = 'INSTALL WIFI AP'
                        AND PLAE_CREATEDCENTER IN ('WI-FI_PROJ_DEPLOY','WI-FI_OP_DEPLOY')
...
INSERT INTO CLARITY_ADMIN.PENDING_WIFI_PE_TASKS
(
REGION,
PROVINCE,
RTOM,
...
GET_BASE_DATA_REC.LOCATION_NAME,
